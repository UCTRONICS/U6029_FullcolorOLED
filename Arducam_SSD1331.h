...
class Arducam_SSD1331 : public virtual Adafruit_GFX {
 public:
  Arducam_SSD1331(uint8_t CS, uint8_t RS, uint8_t SID, uint8_t SCLK, uint8_t RST);
  Arducam_SSD1331(uint8_t CS, uint8_t RS, uint8_t RST);
